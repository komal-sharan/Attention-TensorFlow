...
vqa_data_json = os.path.join(web_path, 'vqa_data1.json')
answer_txt = os.path.join(web_path, 'media/vqa_ans_vqahat.txt')
att_image = os.path.join(web_path, 'media/att_vqahat.jpg')
...
vqa_model = '/home/ksharan1/visualization/san-vqa-tensorflow/model/vqahat_model/san_lstm_att_newest/model-50000'
new_checkpoint= '/home/ksharan1/visualization/san-vqa-tensorflow/vqahat_model/san_lstm_att_newest/model-50000'
...
def test(model_path='vqahat_model/san_lstm_att_newest/model-50000):
    ...
    with tf.device('/cpu: 0'):
    	...
    	saver.restore(sess, '/home/ksharan1/visualization/san-vqa-tensorflow/vqahat_model/san_lstm_att_newest/model-50000')
