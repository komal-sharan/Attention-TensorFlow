...
def upload_vqa(request):
    ...
    att_image_vqahat_url = fs.url('gray.png')
    vqa_data_file = {}     # default image
    if request.method == 'POST':
        imgs_test = json.load(open('/home/ksharan1/visualization/san-vqa-tensorflow/data/vqa_raw_test.json', 'r'))
        indextogive=random.randint(0,len(imgs_test))
        list_of_paths=[]
        list_of_img=[]
        list_of_img=[]
        list_of_vqa_paths=[]
        ...
        #        indextogive=x
        #        break
        vqa_data_file['image'] ="/home/ksharan1/visualization/san-vqa-tensorflow/data/"+imgs_test[indextogive]['img_path']

        question_id=imgs_test[index]['ques_id']



        vqa_data_file['question'] = imgs_test[indextogive]['question']
        ...
        json.dump(vqa_data_file, open('vqa_data1.json', 'w'))
        answer = ''
        answer_vqahat = ''
        time.sleep(5)
        while 1:
            ...
            if fs.exists('vqa_ans_vqahat.txt'):
                with fs.open('vqa_ans_vqahat.txt', 'r') as f:
                    #time.sleep(5)
                    answer_vqahat = f.read()
                    ...
                    att_image_vqahat_url=fs.url('att_vqahat.jpg')
                    fs.delete('vqa_ans_vqahat.txt')
        ...
        return render(request, 'upload.html', {
                ...
                'att_image_url_finetuned':att_image_vqahat_url,
                'input_question': question,
                'vqa_ans': answer,
                'vqa_ans_vqahat':answer_vqahat
